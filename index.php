...
<body>
    ...
    <section>
        <div class="container">
            ...
            ?>
            <img class="title_img" src="img/spa1.jpg" alt="">
            <div class="section">
                <a class="category" href="#">
                    <img class="category_img" src="img/97488.jpg" alt="">
                ...
                <a class="category" href="#">
                    <img class="category_img" src="img/istock.jpg" alt="">
                    <h4 class="category_title">
                        SPA Шоколад
                    </h4>
                    <p class="category_text">
                ...
                <a class="category" href="#">
                    <img class="category_img" src="img/25g.jpg" alt="">
                    <h4 class="category_title">
                        SPA королевских цветов
                    </h4>
                    <p class="category_text">
                        Вдохновляющая Spa программа на линейке топовых материалов с ароматом и пользой королевских цветов!
                    </p>
                    <p class="duration">Длительность - 2 часа</p>
                    <?php 
                        if(isset($_SESSION['days']) && $_SESSION['days'] == 0){
                ...
                <a class="category" href="#">
                    <img class="category_img" src="img/inve.jpg" alt="">
                    <h4 class="category_title">
                        SPA Релаксация
                    </h4>
                    <p class="category_text">
                ...
                <a class="category" href="#">
                    <img class="category_img" src="img/золотое обертывание.jpeg" alt="">
                    <h4 class="category_title">
                        SPA Золото
                    </h4>
                    <p class="category_text">
                ...
                <a class="category" href="#">
                    <img class="category_img" src="img/4091a.jpg" alt="">
                    <h4 class="category_title">
                        SPA Для двоих
                    </h4>
                    <p class="category_text">
                    ...
                    <?php 
                        if(isset($_SESSION['days']) && $_SESSION['days'] == 0){
                            echo '<p class="cost">Стоимость - <s>3950</s> &#8700 <span>3695 &#8700</span></p>';
                        }else{
                            echo '<p class="cost">Стоимость - 3950 &#8700</p>';
                        }
                    ?>
                    <button class="more_detail">Подробнее</button>
                    <button class="sign_up">Записаться</button>
